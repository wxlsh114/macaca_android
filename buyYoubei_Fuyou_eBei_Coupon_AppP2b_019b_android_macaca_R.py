...
class AppP2b(unittest.TestCase):
    ...
    def buy_Youbei(self):
        ...
        driver.element_by_id("com.richfinancial.pujiaosuo:id/invest_pay_value").send_keys("5000")
        sleep(1)
        #e-Bai
        ...
        sleep(3)
        driver.element_by_name("工商银行（尾号0801）").click()
        sleep(2)
        ...
        sleep(4)
        now=time.strftime("%Y-%m-%d %H_%M_%S")
        sf4="./"+now+"_019b_usedcoupon_macaca_R.png"
