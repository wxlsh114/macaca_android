...
class AppP2b(unittest.TestCase):
    ...
    def buy_Zhifuhui(self):
        ...
        sf2="./"+now+"_023_inv_records_macaca_R.png"
        ...
        sleep(3)
        now=time.strftime("%Y-%m-%d %H_%M_%S")
        sf3="./"+now+"_023_inv_detail_macaca_R.png"
        ...
        sleep(2)
        now=time.strftime("%Y-%m-%d %H_%M_%S")
        sf4="./"+now+"_023_xinzhibao_macaca_R.png"
...
if __name__ == '__main__':
    ...
    now=time.strftime("%Y-%m-%d %H_%M_%S")
    filename="./"+now+"_023_result_macaca_R.html"
    fp=open(filename,"wb")
    runner=HTMLTestRunner(stream=fp,title='51p2b of App environment android6.0.1[投资智福汇(用薪智宝余额支付)] test case report by Macaca',
