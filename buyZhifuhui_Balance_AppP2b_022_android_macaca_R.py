...
class AppP2b(unittest.TestCase):
    ...
    def buy_Zhifuhui(self):
        ...
        sleep(3)
        #Zhifuhui
        driver.element_by_name("智福汇B").click()
        sleep(5)
        ...
        sf2="./"+now+"_022_inv_records_macaca_R.png"
        ...
        sleep(3)
        now=time.strftime("%Y-%m-%d %H_%M_%S")
        sf3="./"+now+"_022_inv_detail_macaca_R.png"
...
if __name__ == '__main__':
    ...
    now=time.strftime("%Y-%m-%d %H_%M_%S")
    filename="./"+now+"_022_result_macaca_R.html"
    fp=open(filename,"wb")
    runner=HTMLTestRunner(stream=fp,title='51p2b of App environment android6.0.1[投资智福汇(用账户余额支付)] test case report by Macaca',
