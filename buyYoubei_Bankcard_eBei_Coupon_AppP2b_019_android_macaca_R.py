...
class AppP2b(unittest.TestCase):
    ...
    def buy_zhuanbei(self):
        ...
        driver.element_by_id("com.richfinancial.pujiaosuo:id/invest_pay_value").send_keys("5900")
        sleep(2)
        #e-Bai
        ...
        sleep(3)
        driver.element_by_id("com.richfinancial.pujiaosuo:id/msm_time").click()
        driver.element_by_id("com.richfinancial.pujiaosuo:id/msm_time").send_keys("123456")
        sleep(2)
        driver.element_by_name("我同意").click()
        sleep(2)
        #OK
        ...
        sleep(4)
        now=time.strftime("%Y-%m-%d %H_%M_%S")
        sf4="./"+now+"_019_usedcoupon_macaca_R.png"
        ...
        sleep(4)
        now=time.strftime("%Y-%m-%d %H_%M_%S")
        sf5="./"+now+"_019_eBei_macaca_R.png"
...
if __name__ == '__main__':
    ...
    now=time.strftime("%Y-%m-%d %H_%M_%S")
    filename="./"+now+"_019_result_macaca_R.html"
    fp=open(filename,"wb")
    runner=HTMLTestRunner(stream=fp,title='51p2b of App environment android6.0.1[投资优贝(用银行卡支付,用e贝和投资券抵扣)] test case report by Macaca',
