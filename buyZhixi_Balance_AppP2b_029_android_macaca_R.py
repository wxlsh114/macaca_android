...
class AppP2b(unittest.TestCase):
    ...
    def buy_Zhixi(self):
        ...
        sf2="./"+now+"_029_inv_records_macaca_R.png"
        ...
        sleep(3)
        now=time.strftime("%Y-%m-%d %H_%M_%S")
        sf3="./"+now+"_029_inv_detail_macaca_R.png"
...
if __name__ == '__main__':
    ...
    now=time.strftime("%Y-%m-%d %H_%M_%S")
    filename="./"+now+"_029_result_macaca_R.html"
    fp=open(filename,"wb")
    runner=HTMLTestRunner(stream=fp,title='51p2b of App environment android6.0.1[投资智息双全(用账户余额支付)] test case report by Macaca',
