...
class AppP2b(unittest.TestCase):
    ...
    def buy_zhuanbei(self):
        ...
        driver.element_by_id("com.richfinancial.pujiaosuo:id/invest_pay_value").send_keys("9800")
        sleep(2)
...
if __name__ == '__main__':
    ...
    now=time.strftime("%Y-%m-%d %H_%M_%S")
    filename="./"+now+"_008_result_macaca_R.html"
    fp=open(filename,"wb")
    runner=HTMLTestRunner(stream=fp,title='51p2b of App environment android6.0.1(投资赚呗(用薪智宝+账户余额支付) test case report by Macaca',
